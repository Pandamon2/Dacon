...
model.fit(X_resampled, y_resampled)  # Use resampled data for final training
...
# 예측 결과를 CSV 파일로 저장
submission.to_csv('submission_RandomForestClassifier_class_weight_SMOTE.csv', index=False, encoding='utf-8-sig')