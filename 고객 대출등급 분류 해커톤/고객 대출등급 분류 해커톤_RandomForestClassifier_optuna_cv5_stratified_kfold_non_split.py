...
submission.to_csv('submission_RandomForestClassifier_optuna_cv5_KFold_non_split_class_weight_240206.csv', index=False, encoding='utf-8-sig')

#################################################################### 이거 돌려보고 제출해서 점수 확인해보기